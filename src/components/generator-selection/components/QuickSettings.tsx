...
import type { UsageEnvironment, UsageType, GeneratorGroup, StepLoadPercent } from '../types';
...
const environmentIcons: Record<string, React.ComponentType<{ className?: string }>> = {
  Home, Store, Heart, Factory, HardHat, Mountain, Wheat, Ship, Radio, Music,
};

const usageTypeOptions: { id: UsageType; label: string; desc: string; tooltip: string }[] = [
  {
    id: 'standby',
    label: 'Standby',
    desc: 'Yedek güç',
    tooltip: 'Sadece şebeke kesintilerinde devreye girer. Yıllık çalışma süresi düşüktür. En ekonomik seçenektir.',
  },
  {
    id: 'prime',
    label: 'Prime',
    desc: 'Ana güç',
    tooltip: 'Düzenli olarak ana güç kaynağı olarak kullanılır. Değişken yük altında sürekli çalışabilir. Şebeke olmayan veya yetersiz olduğu alanlarda tercih edilir.',
  },
  {
    id: 'continuous',
    label: 'Continuous',
    desc: '7/24 kesintisiz',
    tooltip: 'Sabit yük altında 7/24 kesintisiz çalışma için tasarlanmıştır. En yüksek dayanıklılık ve kapasite gerektirir.',
  },
];

const generatorGroupOptions: { id: GeneratorGroup; label: string; tooltip: string }[] = [
  { id: 'any', label: 'Farketmez', tooltip: 'Jeneratör grubu belirtilmez, genel hesaplama yapılır.' },
  { id: 'G1', label: 'G1', tooltip: 'Küçük güç grubu (< 50 kVA). Konut, küçük işletme ve ofis kullanımına uygundur.' },
  { id: 'G2', label: 'G2', tooltip: 'Orta güç grubu (50-250 kVA). Orta ölçekli işletme, AVM ve hastane gibi tesisler için uygundur.' },
  { id: 'G3', label: 'G3', tooltip: 'Büyük güç grubu (> 250 kVA). Fabrika, maden ve büyük endüstriyel tesisler için uygundur.' },
];
    ...
    <div className="p-4 border-t border-gray-100 space-y-4">
      ...
      <div>
        <div className="flex items-center gap-1.5 mb-2">
          ...
          <label className="text-xs font-medium text-gray-600">Kullanım Tipi</label>
          <InfoTooltip
            title="Kullanım Tipi"
          ...
          {usageTypeOptions.map((option) => {
            ...
            return (
              ...
              >
                ...
                <span className={`block text-[10px] mt-0.5 ${isSelected ? 'text-blue-600' : 'text-gray-500'}`}>
                  {option.desc}
                </span>
              </button>
            );
      ...
      <div>
        <div className="flex items-center gap-1.5 mb-2">
          ...
          <label className="text-xs font-medium text-gray-600">Jeneratör Grubu</label>
          <InfoTooltip
        ...
        {generatorGroup !== 'any' && (
          <div className="mt-3">
            <div className="flex items-center gap-1.5 mb-2">
              ...
              <label className="text-xs font-medium text-gray-600">İlk Adım Yükü</label>
              <InfoTooltip
                title="İlk Adım Yükü"
      ...
      <div>
        <div className="flex items-center gap-1.5 mb-2">
          ...
          <label className="text-xs font-medium text-gray-600">Kullanım Ortamı</label>
          <InfoTooltip
      ...
      <div>
        <div className="flex items-center gap-1.5 mb-2">
          ...
          <label className="text-xs font-medium text-gray-600">Menşei Tercihi</label>
          <InfoTooltip
            title="Menşei Tercihi"
